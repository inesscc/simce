...
preds = pd.read_excel(dirs['dir_predicciones'] / 'predicciones_modelo.xlsx')
preds['indices'] = preds.ruta_imagen_output.apply(lambda x: get_indices_tinta(x))
...
for col in split.columns:
    ...
    test_final = pd.concat([preds_final, col_split], axis = 1)
